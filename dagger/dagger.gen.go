...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "HarborCli":
		...
		// 	var directoryArg *Directory
		// 	if inputArgs["directoryArg"] != nil {
		// 		err = json.Unmarshal(inputArgs["directoryArg"], &directoryArg)
		// 		if err != nil {
		// 			panic(fmt.Errorf("%s: %w", "failed to unmarshal input arg directoryArg", err))
		// 		}
		// 	}
		...
		// 		}
		// 	}
		// 	return (*HarborCli).Build(&parent, ctx, directoryArg)
		default:
		...
		return dag.Module().
			WithObject(
				dag.TypeDef().WithObject("HarborCli").
					...
					// 		dag.TypeDef().WithObject("Container")).
					// 		WithDescription("example usage: \"dagger call lint-code --directory-arg .\"").
					// 		WithArg("directoryArg", dag.TypeDef().WithObject("Directory"))).
					// WithFunction(
					// 	dag.Function("Build",
					// 		dag.TypeDef().WithKind(TypeDefKind(err.Error()))).
					// 		WithDescription("example usage: \"dagger call build --directory-arg .\"").
					// 		WithArg("directoryArg", dag.TypeDef().WithObject("Directory")))), nil
	default:
